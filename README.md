...
Contributing
- Feel free to open issues or pull requests for improvements — e.g., to add tests, remove hardcoded secrets, or extend the recommendation logic.

License
- Add your preferred license file (e.g., MIT, Apache-2.0) if you want this repo to be explicitly licensed.

Acknowledgements
- Data and posters: The TMDB dataset and TMDB API are used for movie metadata and images.
